...
export const processIntro =
  'Alcance cerrado y entrega predecible. Los agentes aceleran el trabajo; el criterio es mío.';

export const processSteps = [
  {
    title: 'Brief',
    body: 'Me cuentas negocio, objetivo, referencias y plazo. Es gratis.',
  },
  {
    title: 'Propuesta en 48 h',
    body: 'Alcance, plazos y precio por proyecto. Sin tarifas por hora.',
  },
  {
    title: 'Entrega',
    body: 'Specs cortas y agentes para ir más rápido, no para improvisar el producto.',
  },
] as const;

export const processHonesty =
  'Acepto encargos con base de datos. No vendo un equipo backend senior ni DevOps.';
